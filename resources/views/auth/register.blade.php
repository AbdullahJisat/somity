                        ...
                        <div class="login-right-wrap">
                            ...
                            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control emailalert" id="email" name="email" type="text"
                                ...
                                <div class="form-group">
                                    <label for="nid" class="col-form-label text-md-end">{{ __('Nid')
                                        }}</label>
                                    <input type="text" onkeypress="return /[0-9]/i.test(event.key)"
                                        class="form-control phonealert" id="nid" name="nid" value="{{ old('nid') }}"
                                        required autocomplete="nid" placeholder="Nid">
                                    @error('nid')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control passwordalert" type="password" id="password"
                                        name="password" type="text" required autocomplete="new-password"
                                ...
                                <div class="form-group">
                                    <label for="image" class="col-form-label text-md-end">{{ __('Image')
                                        }}&nbsp;
                                        <img id="preview" src="{{ asset('admin') }}/img/file.png" width="30%" />
                                        <input type="file" name="image" id="image" accept="image/*" required
                                            style="visibility: hidden"
                                            onchange="document.getElementById('preview').src = window.URL.createObjectURL(this.files[0])" /></label>
                                    @error('image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
